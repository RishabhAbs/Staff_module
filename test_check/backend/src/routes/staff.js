...
const PROFILE_FIELDS = `
  ...
  phones, personal_emails, emergency_contacts, previous_employments, bank_details
`;
...
router.post('/create', auth, async (req, res) => {
  ...
  try {
    ...
    res.json({ id: result.insertId, name, username, role, status: 'active', phone: phoneVal, number: phoneVal, twoFaSecret: twoFaSecret || null, twoFaSetup: false });
  } catch (err) {
